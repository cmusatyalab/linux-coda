...
// ignore the poor naming, inode timestamps were 32-bit only before 4.18
static struct timespec coda_to_timespec64(struct coda_timespec ts)
{
...
static struct coda_timespec timespec64_to_coda(struct timespec ts32)
{
